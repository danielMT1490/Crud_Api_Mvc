...
namespace Student.Common.Logic.Model
{
    public class AlumnoService
    {
        ...
        public AlumnoService(Guid guid, int Id, string dni, string nombre, string apellidos, int edad, DateTime nacimiento, DateTime registro)
        {
            this.Guid = guid;
            this.Id = Id;
            this.Dni = dni;
        ...
        {
            return obj is AlumnoService student &&
                   Id == student.Id &&
